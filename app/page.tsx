      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="text-center pt-20 pb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight leading-tight">
            Complete Quests.<br />
            <span className="text-blue-400">Earn USDC.</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8">
              ...
              <ul className="space-y-3">
                {[
                  "Post tasks and get real work done by the community",
                  "Set your own reward pool and number of participants",
                  "Review and approve submissions yourself — full control",
                  "Reclaim unused funds after the quest deadline",
                  "Only pay a small 2% platform fee on the reward pool",
                ].map((item) => (
            ...
            <Card className="p-8">
              ...
              <ul className="space-y-3">
                {[
                  "Browse open quests and earn USDC for completing tasks",
                  "Submit proof directly on the quest page — no extra steps",
                  "Track all your submissions and their status in one place",
                  "Claim approved rewards instantly from the smart contract",
                  "Minimum 1 USDC per quest — no micro-rewards",
                ].map((item) => (
                  <li key={item} className="flex items-start gap-2 text-sm text-slate-300">
        ...
        <section className="pb-20 text-center">
          <Card className="p-12 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-blue-500/20">
            ...
            <p className="text-slate-400 mb-8 max-w-lg mx-auto">
              Connect your wallet to create quests or start earning USDC today.
            </p>
            {isAuthenticated ? (
              <Link href="/kwest/browse">
                <Button size="lg">
        ...
        <footer className="border-t border-slate-800 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-slate-500">
              Built on Base. Powered by smart contracts. &copy; 2024 Kwest.
            </p>
          </div>
        </footer>
      </div>
